class Iron < Formula
  ...
  version "0.0.148"
  url "https://github.com/Akinus21/Iron/releases/download/v0.0.148/iron"
  ...
  resource "cef-runtime" do
    url "https://github.com/Akinus21/Iron/releases/download/v0.0.148/cef-runtime.tar.gz"
...
(bin/"iron").write <<~SH
      ...
      export CEF_PARAMETERS="--no-sandbox --disable-gpu --disable-gpu-compositing"
      exec "#{bin}/iron.bin" "$@"
    SH
  end
