class OllamaWorker < Formula
  ...
  on_linux do
    url "https://github.com/Akinus21/ollama-queue-agent/releases/download/v0.0.3/ollama-worker"
    sha256 "bb447e11c29a3a56aca443ef208b6f75906237767721ce2f626036ec781ef208"
  end
